        ...
        <div id="new-message">
            ...
            <ul class="new-message-content">
                <li>
                    ...
                    <div class="img">
                        <ul>
                            <li><a href="/postInfor/post?id=<%=modellist4[0].ID %>" target='_blank'>
                                <img src="<%=modellist4[0].img %>"></a></li>
                            <li><a href="/postInfor/post?id=<%=modellist4[1].ID %>" target='_blank'>
                    ...
                    <div class="explain">
                        <div class="text">
                            <ul>
                                <li><a href="/postInfor/post?id=<%=modellist4[0].ID %>" target='_blank'><span><%=modellist4[0].Title1 %></span></a></li>
                                <li><a href="/postInfor/post?id=<%=modellist4[1].ID %>" target='_blank'><span><%=modellist4[1].Title1 %></span></a></li>
                            </ul>
                        </div>
                        <div class="num">
                            <ul>
                                <li class="in"><a href="/postInfor/post?id=<%=modellist4[0].ID %>" target='_blank'><span>1</span></a></li>
                                <li><a href="/postInfor/post?id=<%=modellist4[1].ID %>" target='_blank'><span>2</span></a></li>
                            </ul>
                        </div>
                    </div>
                </li>
                <li>
                    ...
                    <ul class="new-topics">
                        ...
                        <li>
                            ...
                            <a href="/postInfor/post?id=<%=item.ID %>" target='_blank'><%=item.Title %></a>
                        </li>
                        <% }
                        %>
                    </ul>
                ...
                <li>
                    ...
                    <ul class="new-topics">
                        ...
                        <li>
                            <img src="../../image/list_7ree.gif" />
                            <a href="/postInfor/post?id=<%=item.ID %>" target='_blank'><%=item.Title1 %></a>
                        </li>
                        <%} 
                        %>
                    </ul>
                ...
                <li>
                    ...
                    <ul class="new-topics">
                        ...
                        <li>
                            <img src="../../image/list_7ree.gif" />
                            <a href="/postInfor/post?id=<%=item.ID %>" target='_blank'><%=item.Title2 %></a>
                        </li>
                        <% }
                        %>
                    </ul>
